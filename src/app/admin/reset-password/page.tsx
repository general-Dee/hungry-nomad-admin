...
function ResetPasswordForm() {
  ...
  return (
    <AuthCard>
      ...
      {!tokenHash ? (
        <p className="text-muted" style={{ textAlign: 'center', fontSize: 14 }}>This reset link is invalid.</p>
      ) : status === 'error' ? (
        ...
        <>
          <p className="text-muted" style={{ textAlign: 'center', fontSize: 14, marginBottom: 'var(--space-4)' }}>
            Click below to reset your Hungry Nomad admin password.
          </p>
          <button type="button" className="btn btn-primary btn-block" onClick={handleVerify} disabled={status === 'verifying'}>
